datevar=250415422020
mkdir $datevar
cp avg_fitness.svg config-ff ffnn.log Digraph.gv Digraph.gv.svg neat-checkpoint-128 speciation.svg $datevar
git add -f save_data.sh avg_fitness.svg config-ff ffnn.log Digraph.gv Digraph.gv.svg neat-checkpoint-128 speciation.svg evoalg.py game.py
...
git commit -m "replication of albantiks, no fixed-topology, pop 1000, low mutation rates"
