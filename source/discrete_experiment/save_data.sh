datevar=230422172020
mkdir $datevar
cp avg_fitness.svg config-ff ffnn.log Digraph.gv Digraph.gv.svg neat-checkpoint-61 speciation.svg $datevar
git add -f save_data.sh avg_fitness.svg config-ff ffnn.log Digraph.gv Digraph.gv.svg neat-checkpoint-61 speciation.svg evoalg.py game.py
