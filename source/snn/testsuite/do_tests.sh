...
TEST_BASEDIR=${NEST_DOC_DIR:-"/home/dansan/nest2.20/share/doc/nest"}
...
PYTHON_HARNESS="${NEST_DATA_DIR:-/home/dansan/nest2.20/share/nest}/extras/do_tests.py"
...
echo >  "${TEST_LOGFILE}" "NEST v. nest-2.20.0 testsuite log"
echo >> "${TEST_LOGFILE}" "======================"
...
if test "x${TEST_PYNEST}" = xtrue ; then
    ...
    if command -v /home/dansan/anaconda3/bin/nosetests >/dev/null 2>&1 && /home/dansan/neuromorphic/source/snn/necoenv/bin/python /home/dansan/anaconda3/bin/nosetests --with-xunit --xunit-file=/dev/null --where=${TEST_OUTDIR} >/dev/null 2>&1; then

        echo
        echo "  Using nosetests."
        echo

        /home/dansan/neuromorphic/source/snn/necoenv/bin/python /home/dansan/anaconda3/bin/nosetests -v --with-xunit --xunit-file=${TEST_OUTDIR}/pynest_tests.xml ${NEST_PYTHON_PREFIX:-/home/dansan/nest2.20/lib/python3.7/site-packages}/nest/tests ${NEST_PYTHON_PREFIX:-/home/dansan/nest2.20/lib/python3.7/site-packages}/nest/topology/tests 2>&1 \
